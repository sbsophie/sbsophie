...
- 🗓️ **수행 기간** : 2025.02.21 ~ 2025.03.10 (팀 프로젝트 / 4인)
- 🛠️ **핵심 기술** : Java, Servlet/JSP, MariaDB, MyBatis, Bootstrap, jQuery
- 🧩 **주요 기능**
  - 🎥 **영화 API 연동** : JSON 기반 외부 API 호출 → Jackson으로 파싱 → 영화 리스트/상세 페이지 구현
  - 💬 **자유게시판 CRUD** : 게시글 작성, 수정, 삭제, 페이징, 실시간 유효성 검사, 비동기 처리(AJAX)
- 🧱 **트러블슈팅**
...
<table>
  ...
  <tr>
    <td>SQLD (SQL 개발자)</td>
    <td>2025.03</td>
    <td><img src="https://img.shields.io/badge/최종합격-brightgreen"/></td>
    <td>한국데이터베이스진흥센터</td>
  </tr>
  <tr>
    <td>정보처리기사</td>
    <td>2025.02</td>
    <td><img src="https://img.shields.io/badge/필기합격-yellow"/></td>
    <td>한국산업인력공단</td>
  </tr>
  <tr>
    <td>ACA Photoshop CC 2015</td>
    <td>2020.10</td>
    <td><img src="https://img.shields.io/badge/최종합격-brightgreen"/></td>
    <td>ADOBE</td>
  </tr>
  <tr>
    <td>ACA Illustrator CC 2015</td>
    <td>2020.10</td>
    <td><img src="https://img.shields.io/badge/최종합격-brightgreen"/></td>
    <td>ADOBE</td>
  </tr>
